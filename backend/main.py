...
# Import routers
from routers import auth, teachers, subjects, assignments, rooms, timetable, departments, public, users, restrictions, dashboard, settings, students, makeup, autofix
